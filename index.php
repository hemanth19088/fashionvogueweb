		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 wow fadeInRight" data-wow-delay="600ms" data-wow-duration="1500ms">
				<div class="ori-app-launch-text">
					<h3>Stay Tuned for the FashionVogue App!</h3>
					<p>
						We are excited to announce that the FashionVogue mobile app is coming soon to both iOS and Android devices. Get ready to experience a whole new world of fashion at your fingertips.
					</p>
					<p>
						Be the first to know when it drops! Subscribe to our newsletter for exclusive updates, early access, and special launch day offers.
					</p>
					<div class="ori-btn-1 text-uppercase mt-4">
						<a href="login.html">Notify Me</a>
					</div>
				</div>
			</div>
		</div>
